 ...
 function Nav() {
  return (
   <div className=' d-flex justify-content-center poppins-regular bg-black  '>
    ...
    <a href='/Abdelrahman mostafa cv.docx' download={"/Abdelrahman mostafa cv.docx"} className='m-3 px-4 text-decoration-none text-white'><span className='purple-hover'>Resume</span></a>
    </div>
   </div>
  );
}
